...
A supply chain tracking system With tags built in Rust. For now it works completely fine on multiple terminals, just to show case my project functionality through a single device. But as the project will grow it will work on multiple devices just like real blockchain used to work.  
